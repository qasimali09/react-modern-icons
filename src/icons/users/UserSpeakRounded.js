...
function UserSpeakRounded({ color, strokeWidth, variant }) {
  const defaultIcon = () => (
    <g>
      <svg
        width="24"
  ...
  const filledIcon = () => (
    <g>
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="10" cy="6.75" r="4" fill="#1C274C" />
        <ellipse cx="10" cy="17.75" rx="7" ry="4" fill="#1C274C" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export default generateIcon(UserSpeakRounded);

UserSpeakRounded.propTypes = {
  color: PropTypes.string,
  strokeWidth: PropTypes.string,
  variant: PropTypes.oneOf(['light', 'regular', 'bold', 'filled']),
};

UserSpeakRounded.defaultProps = {
  color: 'currentColor',
  strokeWidth: '1.5px',
  variant: 'regular',
};
